...
class CustomerTest < ActiveSupport::TestCase
 ...
 def setup
     @customer = Customer.new(customername: "john", email: "john@example.com")
 end
...
test "customername length should not be too long" do 
@customer.customername = "a" * 41
assert_not @customer.valid?
end

test "customername length should not be too short" do 
